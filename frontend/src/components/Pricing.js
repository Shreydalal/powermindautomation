            ...
            <div className="container mx-auto px-4">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6">
                        A Full-Time Front Desk for a Fraction of the Cost
                    </h2>
                    <p className="text-lg text-slate-600">
                        Hiring, training, and managing full-time front-desk staff to handle calls, manage WhatsApp, and cover weekends costs thousands of Rupees monthly not to mention the headache of staff turnover.
                    </p>
                </motion.div>
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center">
                            <div className="flex-1">
                                ...
                                <ul className="space-y-4">
                                    {[
                                        "Custom AI Voice Agent (Inbound Call-to-WhatsApp)",
                                        "Official WhatsApp Business & Instagram Automation",
                                        "Smart Calendar Integration (Practo/Google)",
                                        "24/7 After-Hours & Weekend Coverage",
                                        "Lead Qualification & Dashboard Analytics",
                                        "Monthly Performance Reports & Audits"
                                    ].map((item, i) => (
                                        <motion.li
                                            key={i}
                            ...
                            >
                                ...
                                <div className="text-4xl font-bold mb-2">Cost of Cutting Chai</div>
